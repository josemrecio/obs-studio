...
__TMP_GITHUB_REF=$(git describe --abbrev=0)
...
install_name_tool -change /tmp/obsdeps/lib/libmbedtls.2.16.5.dylib @executable_path/../Frameworks/libmbedtls.2.16.5.dylib ./OBS.app/Contents/Plugins/obs-outputs.so
install_name_tool -change /tmp/obsdeps/lib/libmbedcrypto.2.16.5.dylib @executable_path/../Frameworks/libmbedcrypto.2.16.5.dylib ./OBS.app/Contents/Plugins/obs-outputs.so
install_name_tool -change /tmp/obsdeps/lib/libmbedx509.2.16.5.dylib @executable_path/../Frameworks/libmbedx509.2.16.5.dylib ./OBS.app/Contents/Plugins/obs-outputs.so
...
# TODO: josemrecio - add sparkle support
...
plutil -insert CFBundleVersion -string $(basename ${__TMP_GITHUB_REF}) ./OBS.app/Contents/Info.plist
plutil -insert CFBundleShortVersionString -string $(basename ${__TMP_GITHUB_REF}) ./OBS.app/Contents/Info.plist
